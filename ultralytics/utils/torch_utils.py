...
def strip_optimizer(f: Union[str, Path] = "SUDCN.pt", s: str = "") -> None:
    """
    Strip optimizer from 'f' to finalize training, optionally save as 's'.

    Args:
        f (str): file path to model to strip the optimizer from. Default is 'SUDCN.pt'.
    ...
    def __call__(self, epoch, fitness):
        ...
        if stop:
            ...
            LOGGER.info(
                ...
                f"Best results observed at epoch {self.best_epoch}, best model saved as SUDCN.pt.\n"
