...
model = YOLO("path/to/SUDCN.pt")  # Load a custom trained model
...
yolo track model=path/to/SUDCN.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/SUDCN.pt tracker="bytetrack.yaml"
```
